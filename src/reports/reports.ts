...
export type ContactEntry = { name: string; phone: string; note?: string; source: ContactSource }
...
export const FEATURED_ALERTS: FeaturedAlert[] = [
  {
    org: 'NueveOnce',
    headline: 'Telemedicina gratuita ante el sismo · Médicos y paramédicos disponibles',
    phone: '0800-4662400',
...
export const REGIONAL: Partial<Record<string, ContactEntry[]>> = {
  'Distrito Capital': [
    { name: 'Bomberos Metropolitanos', phone: '0212-545-4545', source: { label: 'El Espectador, jun. 2026', url: EE } },
    { name: 'Protección Civil DC', phone: '0212-575-3332', source: { label: 'Efecto Cocuyo', url: EC } },
  ],
  'La Guaira': [
    { name: 'Bomberos La Guaira', phone: '0212-332-2165', source: { label: 'El Espectador, jun. 2026', url: EE } },
    { name: 'Protección Civil La Guaira', phone: '0424-207-5335', source: { label: 'El Espectador, jun. 2026', url: EE } },
  ],
  Miranda: [
    { name: 'Bomberos Los Teques', phone: '0212-322-9038', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Protección Civil Miranda', phone: '0212-383-7849', source: { label: 'El Espectador, jun. 2026', url: EE } },
    { name: 'Cruz Roja — Charallave', phone: '0414-276-6421', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
  Aragua: [
    { name: 'Bomberos de Aragua', phone: '0243-235-1346', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Protección Civil Aragua', phone: '0243-247-4940', source: { label: 'El Espectador, jun. 2026', url: EE } },
    { name: 'Cruz Roja — Maracay', phone: '0243-553-2629', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
  Carabobo: [
    { name: 'Bomberos de Valencia', phone: '0241-838-7372', source: { label: 'El Espectador, jun. 2026', url: EE } },
    { name: 'Bomberos Puerto Cabello', phone: '0242-362-2461', source: { label: 'El Espectador, jun. 2026', url: EE } },
    { name: 'Protección Civil Carabobo', phone: '0241-859-2171', source: { label: 'El Espectador, jun. 2026', url: EE } },
    { name: 'Cruz Roja — Valencia', phone: '0241-825-6436', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
  Yaracuy: [
    { name: 'Bomberos San Felipe', phone: '0254-234-5533', source: { label: 'El Espectador, jun. 2026', url: EE } },
    { name: 'Protección Civil Yaracuy', phone: '0424-781-7515', source: { label: 'El Espectador, jun. 2026', url: EE } },
  ],
  Zulia: [
    { name: 'Bomberos San Francisco', phone: '0800-233-5787', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Protección Civil Zulia', phone: '0261-757-6761', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Cruz Roja — Maracaibo', phone: '0261-798-6455', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
  Táchira: [
    { name: 'Bomberos de Táchira', phone: '0276-353-4344', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Protección Civil Táchira', phone: '0276-516-5460', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Cruz Roja — San Cristóbal', phone: '0276-343-4214', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
  Mérida: [
    { name: 'Bomberos Mérida', phone: '0274-266-3612', note: 'Alternativo — principal: 171', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Cruz Roja — Mérida', phone: '0274-263-2219', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
  Bolívar: [
    { name: 'Cruz Roja — Ciudad Bolívar', phone: '0285-654-7001', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
  Falcón: [
    { name: 'Bomberos Carirubana', phone: '0269-245-8246', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Protección Civil Falcón', phone: '0268-252-4449', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Cruz Roja — Coro', phone: '0268-252-3427', source: { label: 'Cruz Roja Venezolana', url: CR } },
    { name: 'Cruz Roja — Punto Fijo', phone: '0269-245-9434', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
  'Nueva Esparta': [
    { name: 'Bomberos Nueva Esparta', phone: '0295-264-1445', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Protección Civil Nueva Esparta', phone: '0295-263-8052', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Cruz Roja — Porlamar', phone: '0295-417-5560', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
  Anzoátegui: [
    { name: 'Bomberos Barcelona', phone: '0281-276-0066', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Protección Civil Anzoátegui', phone: '0281-277-0791', source: { label: 'Efecto Cocuyo', url: EC } },
    { name: 'Cruz Roja — Barcelona', phone: '0281-274-2090', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
  Lara: [
    { name: 'Cruz Roja — Barquisimeto', phone: '0251-808-9694', source: { label: 'Cruz Roja Venezolana', url: CR } },
  ],
}
